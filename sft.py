...
class TaskHParams:
    ...
    #query_dataset: str = "cleanrl/summarize_from_feedback_tldr_3_filtered_oai_preprocessing_1704578687" # pythia 6.8
...
class Args:
    ...
    # other args
    #base_model: str = "EleutherAI/pythia-6.9b-deduped"
