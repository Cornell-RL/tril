...
class CiderScorer(object):
    ...
    def compute_cider(self):
        def counts2vec(cnts):
            """
            Function maps counts of ngram to vector of tfidf weights. The function
            returns vec, an array of dictionary that store mapping of n-gram and
            tf-idf weights. The n-th entry of array denotes length of n-grams.
            ...
            for ngram, term_freq in cnts.items():
                ...
                # compute norm for the vector.  the norm will be used for computing similarity # noqa
...
class Cider:
    ...
    def compute_score(self, gts, res, spacy_preprocess=False):
        ...
        individual_scores = {image_id: score for image_id, score in zip(imgIds, scores)}
